...
export function createMockDbAdapter(overrides?: Partial<Record<keyof DbAdapter, unknown>>): DbAdapter {
  ...
  const base: DbAdapter = {
    ...
    getRequirementsByProject: noopArray,
    ...
    deleteCardRequirement: noop,
    deleteCardFact: noop,
    deleteCardAssumption: noop,
    deleteCardQuestion: noop,
    ...
    insertSystemPolicyProfile: noop,
