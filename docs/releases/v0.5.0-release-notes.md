...
- **Install:** One-shot run: `npx dossier-agentic-product-planner-builder` (or clone and build from source). See [releases and installability strategy](docs/strategy/releases-and-installability-strategy.md).
